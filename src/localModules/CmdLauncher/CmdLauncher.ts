...
export class CmdLauncher {
	...
	//-- singleton
	public static instance:CmdLauncher;
	public static getInstance():CmdLauncher {
		if( !CmdLauncher.instance ){
			CmdLauncher.instance = new CmdLauncher();
		}
		return( CmdLauncher.instance );
	}
